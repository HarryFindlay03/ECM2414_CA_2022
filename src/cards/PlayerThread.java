...
public class PlayerThread implements Runnable {
    ...
    public void run() {
        ...
        String playerFileName = String.format("output-files/playerfiles/player%d_output.txt", player.getPlayerId());
    ...
    void gameEnd(Player player) {
        while (!gameComplete) {
            ...
            try {
                FileWriter writer = new FileWriter(String.format("output-files/playerfiles/player%d_output.txt", player.getPlayerId()), true);
            ...
            try {
                for (int i = 0; i < decksInGame.size(); i++) {
                    ...
                    FileWriter deckWriter = new FileWriter(String.format("output-files/deckfiles/deck%d_output.txt", deckId));
